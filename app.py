...
def home():
    ...
    with col1:
        st.image("https://cdn.pixabay.com/photo/2016/11/22/23/24/pills-1851260_1280.jpg", caption="Smart Medication Management", width=100)
...
def condition_recognizer():
    ...
    if uploaded_file:
        ...
        st.image("https://cdn.pixabay.com/photo/2017/06/20/19/22/eczema-2428710_1280.jpg", caption="Sample Skin Condition", width=250)
        st.info("Demo data for preview:")
